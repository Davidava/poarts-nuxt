...
import require$$0, { getCurrentInstance, reactive, toRef, defineComponent, computed, h, resolveComponent, watchEffect, ref, Suspense, Transition, useSSRContext, mergeProps, shallowRef, withCtx, createTextVNode, toDisplayString as toDisplayString$1, unref, onErrorCaptured, defineAsyncComponent, isRef, createVNode, createApp } from "vue";
import { joinURL, hasProtocol, withBase, withQuery } from "ufo";
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderSuspense, ssrRenderAttr, ssrRenderList } from "vue/server-renderer";
...
const components = {};
function components_03be7269(nuxtApp) {
...
const vueuseHead_09fe2624 = defineNuxtPlugin((nuxtApp) => {
...
const plugin_c24b7e3c = defineNuxtPlugin((nuxtApp) => {
  ...
  setup(props) {
    ...
    return () => {
      return h(vueRouter_cjs_prod.RouterView, {}, {
        default: (routeProps) => {
          var _a;
          return routeProps.Component && _wrapIf(Transition, (_a = routeProps.route.meta.pageTransition) != null ? _a : defaultPageTransition, wrapInKeepAlive(routeProps.route.meta.keepalive, h(Suspense, {
...
const _sfc_main$d = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "c-archive" }, _attrs))}><div class="o-box"><div class="c-archive-heading"><h1 class="c-title">GET INSPIRED BY OUR ARCHIVE</h1><p> Explore our infinite archive, full of inspiration and work we made for our clients. </p></div><div class="c-archive-list"></div></div></div>`);
    };
  }
});
...
const meta$1 = void 0;
const _imports_0 = `${publicAssetsURL()}home-page.mp4`;
const meta = void 0;
const routes = [
  {
    name: "archive",
...
const router_50508306 = defineNuxtPlugin((nuxtApp) => {
...
const Error404 = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-4858155c"]]);
...
const Error500 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-9a8444be"]]);
...
const _sfc_main$a = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "font-sans antialiased bg-cloud-surface dark:bg-sky-darker text-sky-darkest dark:text-sky-surface" }, _attrs))} data-v-a3f96ea8><div class="min-h-screen md:flex" data-v-a3f96ea8><div class="flex items-center justify-center w-full max-w-full" data-v-a3f96ea8><div class="max-w-full lg:max-w-10xl m-8 p-4" data-v-a3f96ea8><div class="md:max-w-sm text-5xl font-bold dark:text-white md:text-15xl" data-v-a3f96ea8>${__props.statusCode}</div><div class="w-16 h-1 my-3 bg-primary md:my-6" data-v-a3f96ea8></div><div class="mb-8 text-2xl font-light leading-normal dark:text-cloud-lighter md:text-3xl max-w-sm" data-v-a3f96ea8>${__props.description}</div><div class="mb-8 text-sm leading-normal dark:text-cloud-lighter md:text-lg white overflow-scroll max-w-full" data-v-a3f96ea8>${__props.stack}</div></div></div></div></div>`);
    };
  }
};
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderSuspense(_push, {
        default: () => {
          if (unref(error)) {
            _push(ssrRenderComponent(unref(_sfc_main$9), { error: unref(error) }, null, _parent));
          } else {
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$6]]);
let entry;
const plugins = normalizePlugins(_plugins);
{
  entry = async function createNuxtAppServer(ssrContext = {}) {
    const vueApp = createApp(_sfc_main$8);
...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "c-home" }, _attrs))}><div class="c-home-top"><video playsinline autoplay loop muted type="video/mp4" preload${ssrRenderAttr("src", _imports_0)} data-video="0"></video><div class="c-home-top__inner"><div class="o-box"><h1><b>THE</b><b>CREATIVE</b><b>AGENCY IN</b><b>SPORTS</b></h1></div></div></div></div>`);
}
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<header${ssrRenderAttrs(mergeProps({ class: "c-header" }, _attrs))}><div class="c-header-wrap"><div class="c-header-logo"><a href="#"> POARTS </a></div><div class="c-header-burger"><button class="c-header-burger__button"></button></div></div></header>`);
}
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_NuxtLink = __nuxt_component_0$2;
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "c-menu" }, _attrs))}><nav class="c-menu-nav"><div class="o-box"><ul class="c-menu-nav__list"><!--[-->`);
  ssrRenderList(_ctx.nav, (item) => {
    ...
    _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<h2 class="c-menu-nav__row2"${_scopeId}><div class="u-bg"${_scopeId}></div> ${ssrInterpolate(item.name)}</h2><h2 class="c-menu-nav__row1"${_scopeId}>${ssrInterpolate(item.name)}</h2>`);
        } else {
          return [
            createVNode("h2", { class: "c-menu-nav__row2" }, [
              createVNode("div", { class: "u-bg" }),
              createTextVNode(" " + toDisplayString$1(item.name), 1)
            ]),
            createVNode("h2", { class: "c-menu-nav__row1" }, toDisplayString$1(item.name), 1)
          ];
        }
      }),
      _: 2
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "c-footer" }, _attrs))}><div class="o-box"><div class="c-footer-inner"><div class="c-footer-socials"><a href="https://instagram.com/poarts" target="_blank"></a><a href="https://www.facebook.com/artem.podrez" target="_blank"></a></div></div></div></footer>`);
}
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_header_component = __nuxt_component_0;
  const _component_menu_component = __nuxt_component_1;
  const _component_NuxtPage = resolveComponent("NuxtPage");
  const _component_footer_component = __nuxt_component_2;
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "c-app" }, _attrs))}>`);
  _push(ssrRenderComponent(_component_header_component, null, null, _parent));
  _push(ssrRenderComponent(_component_menu_component, null, null, _parent));
